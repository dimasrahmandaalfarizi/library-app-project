...
@JsonKey(name: 'id') int get id;@JsonKey(name: 'nama_penerbit') String get name;@JsonKey(name: 'lokasi_penerbit') String? get location;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PublisherModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.location, location) || other.location == location));
}
...
@override
String toString() {
  return 'PublisherModel(id: $id, name: $name, location: $location)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int id,@JsonKey(name: 'nama_penerbit') String name,@JsonKey(name: 'lokasi_penerbit') String? location
});
...
/// Create a copy of PublisherModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? location = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'nama_penerbit')  String name, @JsonKey(name: 'lokasi_penerbit')  String? location)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PublisherModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'nama_penerbit')  String name, @JsonKey(name: 'lokasi_penerbit')  String? location)  $default,) {final _that = this;
switch (_that) {
case _PublisherModel():
return $default(_that.id,_that.name,_that.location);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id')  int id, @JsonKey(name: 'nama_penerbit')  String name, @JsonKey(name: 'lokasi_penerbit')  String? location)?  $default,) {final _that = this;
switch (_that) {
case _PublisherModel() when $default != null:
return $default(_that.id,_that.name,_that.location);case _:
  return null;
...
class _PublisherModel implements PublisherModel {
  const _PublisherModel({@JsonKey(name: 'id') required this.id, @JsonKey(name: 'nama_penerbit') required this.name, @JsonKey(name: 'lokasi_penerbit') this.location});
  factory _PublisherModel.fromJson(Map<String, dynamic> json) => _$PublisherModelFromJson(json);

@override@JsonKey(name: 'id') final  int id;
@override@JsonKey(name: 'nama_penerbit') final  String name;
@override@JsonKey(name: 'lokasi_penerbit') final  String? location;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PublisherModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.location, location) || other.location == location));
}
...
/// Create a copy of PublisherModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? location = freezed,}) {
